export class BlogComponent {
    ...
    async init() {
        ...
        try {
            ...
            this.container.innerHTML = '<p class="text-center text-red-400">Failed to load posts.</p>';
        }
    }

    render(posts) {
        if (!posts || posts.length === 0) {
            this.container.innerHTML = '<p class="text-center text-gray-400 col-span-full">No posts yet.</p>';
            return;
        }
