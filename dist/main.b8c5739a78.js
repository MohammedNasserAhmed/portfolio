...
const { handleError: handleError, ErrorTypes: ErrorTypes, logInfo: logInfo, validateParams: validateParams } = loadModule(4);
...
const { escapeHTML: escapeHTML, escapeAttr: escapeAttr, createIntersectionObserver: createIntersectionObserver, handleError: handleError, ErrorTypes: ErrorTypes, validateParams: validateParams, logInfo: logInfo, logWarn: logWarn } = loadModule(4);
...
class SkillsComponent {
    ...
    createProgressSVG(skill) {
        ...
        const outerTrack = document.createElementNS('http:
        ...
        const track = document.createElementNS('http:
        ...
        const progress = document.createElementNS('http:
        ...
        try {
            ...
            items.forEach((item, index) => {
                ...
                if (item.percent !== undefined && 
                    ...
                    logWarn(`Invalid percent value for skill '${item.name}', will be auto-generated`);
                }
            });
            ...
            handleError(
                error,
                'Failed to render skills component',
                ErrorTypes.COMPONENT
            );
