...
class TemplateBuilder {
    ...
    processHelpers(template, data) {
        ...
        return template.replace(/{{([a-zA-Z_][a-zA-Z0-9_]*)\s+([^}]+)}}/g, (match, helperName, args) => {
    ...
    getDefaultData() {
        return {
            ...
            description: 'Portfolio of M. N. Jaber, PhD-level AI Engineer specializing in LLMs, Retrieval-Augmented Generation, and end-to-end machine learning solutions.',
            author: 'M. N. Jaber',
            ...
            ogDescription: 'PhD-level AI Engineer focused on LLM systems, retrieval architectures, and production ML pipelines.',
            ...
            heroDescription: 'PhD-level AI Engineer with deep expertise in AI and ML, specializing in scalable, real-world solutions across supervised, unsupervised, and reinforcement learning.',
            ...
            footerDescription: 'I\'m always open to discussing new projects, creative ideas, or opportunities to be part of an ambitious vision. Feel free to reach out.',
            contactEmail: 'mohnasgr@ainarabic.io',
            copyright: '© 2025 M. N. Jaber. All Rights Reserved. Designed & Coded with a passion for AI.',
